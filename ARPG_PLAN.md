...
- **Pyro Void Rift (key 5)** — done (unlocks Lv30; original swirl-portal shader in `VoidRift.ts` matching the void-portal reference — violet/blue churn, gold-white inner rim, lightless center; 6x 0.8x grind ticks with implosion pull + slow).
...
- **Skill batch: Gore Hook / Blade Orbit / Flame Dash / Ember Snare / Chain Lightning** — done (berserker yank+burst 4/Lv18; knight orbit blades 4/Lv18; pyro dash+scorch trail 5/Lv25; hunter ember-palette snare 5/Lv25; cryo fork 7/Lv32 with 3-pooled storm bolts; bar/binds generalized to 4 extra slots).
